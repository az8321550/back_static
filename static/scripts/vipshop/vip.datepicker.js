 ...
 * 
 */
VIP.frag["calendarFrag"]='<div id="calendar">'+
	'<div class="main">'+
		'<div class="head">'+
		...
		'<div class="foot">'+
			'<table class="time">'+
				'<tr>'+
					'<td>'+
						'<input type="text" class="hh" maxlength="2" start="00" end="23"/>:'+
						'<input type="text" class="mm" maxlength="2" start="00" end="59"/>:'+
						'<input type="text" class="ss" maxlength="2" start="00" end="59"/>'+
					'</td>'+
...
(function($){
	...
	$.fn.datepicker = function(opts){
		...
		function keydownInt(e){
			if (!((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode == VIP.keyCode.DELETE || e.keyCode == VIP.keyCode.BACKSPACE))) { return false; }
		}
		...
		return this.each(function(){
			...
			$this.click(function(event){
				...
				$(VIP.frag['calendarFrag']).appendTo("body").css({
					left:offset.left+'px',
					top:iTop+'px'
