...
function (e, t) {
    ...
    function i(e) {
        ...
        for (t = "", i = 0, n = e.length; n > i; i++) a = e.charAt(i),
        t += B[a] || a;
        return t
    }
    function n(e, t) {
        for (var i = 0,
        n = t.length; n > i; i += 1) if (r(e, t[i])) return i;
        return -1
    }
    function a() {
        var t = e(H);
    ...
    function d(i) {
        i.on("mousemove",
        function (i) {
            var n = O; (n === t || n.x !== i.pageX || n.y !== i.pageY) && e(i.target).trigger("mousemove-filtered", i)
        })
    }
    function h(e, i, n) {
        n = n || t;
    ...
    function p(e) {
        e[0] !== document.activeElement && window.setTimeout(function () {
            ...
            n = e.val().length;
            e.focus(),
            e.is(":visible") && i === document.activeElement && (i.setSelectionRange ? i.setSelectionRange(n, n) : i.createTextRange && (t = i.createTextRange(), t.collapse(!1), t.select()))
        },
        0)
    }
    function g(t) {
        ...
        var i = 0,
        n = 0;
        if ("selectionStart" in t) i = t.selectionStart,
        n = t.selectionEnd - i;
        else if ("selection" in document) {
            t.focus();
            var a = document.selection.createRange();
            n = document.selection.createRange().text.length,
            a.moveStart("character", -t.value.length),
            i = a.text.length - n
        }
        return {
            offset: i,
    ...
    function v(t) {
        if (!j) {
            ...
            j = e(document.createElement("div")).css({
                position: "absolute",
                left: "-10000px",
                top: "-10000px",
                display: "none",
    ...
    function y(t, i, n) {
        var a, r, o = [];
        a = t.attr("class"),
        a && (a = "" + a, e(a.split(" ")).each2(function () {
    ...
    function b(e, t, n, a) {
        var r = i(e.toUpperCase()).indexOf(i(t.toUpperCase())),
        o = t.length;
    ...
    function w(i) {
        ...
        return function (l) {
            ...
            n = window.setTimeout(function () {
                var n = i.data,
                r = o,
                d = i.transport || e.fn.select2.ajaxDefaults.transport,
                h = {
                    type: i.type || "GET",
                    cache: i.cache || !1,
                ...
                c = e.extend({},
                e.fn.select2.ajaxDefaults.params, h);
                n = n ? n.call(s, l.term, l.page, l.context) : null,
                r = "function" == typeof r ? r.call(s, l.term, l.page, l.context) : r,
                a && a.abort(),
                i.params && (e.isFunction(i.params) ? e.extend(c, i.params.call(s)) : e.extend(c, i.params)),
                e.extend(c, {
                    url: r,
                    dataType: i.dataType,
                    data: n,
    ...
    function C(t) {
        ...
        e.isFunction(a) === !1 && (n = a, a = function () {
            return n
        });
        var o = a();
        ...
        function (t) {
            ...
            return "" === n ? (t.callback(a()), void 0) : (i = function (a, o) {
                ...
                if (a = a[0], a.children) {
                    ...
                    s.children = [],
                    e(a.children).each2(function (e, t) {
                        i(t, s.children)
                    }),
    ...
    function _(i) {
        ...
        return function (a) {
            ...
            e(n ? i() : i).each(function () {
                var e = this.text !== t,
                i = e ? this.text : this; ("" === r || a.matcher(r, i)) && o.results.push(e ? this : {
                    id: this,
                    text: this
                })
            }),
    ...
    if (window.Select2 === t) {
        ...
        I = E(Object, {
            ...
            init: function (i) {
                ...
                this.containerId = "s2id_" + (i.element.attr("id") || "autogen" + D()),
                ...
                this.container.css(k(i.containerCss)),
                this.container.addClass(k(i.containerCssClass)),
                ...
                this.dropdown.addClass(k(i.dropdownCssClass)),
                this.dropdown.data("select2", this),
                this.dropdown.on("click", f),
                this.results = n = this.container.find(h),
                ...
                d(this.results),
                this.dropdown.on("mousemove-filtered touchstart touchmove touchend", h, this.bind(this.highlightUnderEvent)),
                u(80, this.results),
                this.dropdown.on("scroll-debounced", h, this.bind(this.loadMoreIfNeeded)),
                e(this.container).on("change", ".select2-input",
                function (e) {
                    e.stopPropagation()
                }),
                e(this.dropdown).on("change", ".select2-input",
                function (e) {
                    e.stopPropagation()
                }),
                ...
                this.dropdown.on("click mouseup mousedown",
                function (e) {
                    e.stopPropagation()
                }),
            ...
            destroy: function () {
                ...
                i !== t && (i.container.remove(), i.dropdown.remove(), e.removeClass("select2-offscreen").removeData("select2").off(".select2").prop("autofocus", this.autofocus || !1), this.elementTabIndex ? e.attr({
            ...
            prepareOpts: function (i) {
                var n, a, s, l, d = this;
                if (n = i.element, "select" === n.get(0).tagName.toLowerCase() && (this.select = a = i.element), a && e.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"],
                function () {
                    if (this in i) throw new Error("Option '" + this + "' is not allowed for Select2 when attached to a <select> element.")
                }), i = e.extend({},
                {
                    populateResults: function (n, a, r) {
                        var o, s = this.opts.id;
                        o = function (n, a, l) {
                            var h, c, u, p, g, f, m, v, y, b;
                            for (n = i.sortResults(n, a, r), h = 0, c = n.length; c > h; h += 1) u = n[h],
                            g = u.disabled === !0,
                            p = !g && s(u) !== t,
                            f = u.children && u.children.length > 0,
                            m = e("<li></li>"),
                            m.addClass("select2-results-dept-" + l),
                            m.addClass("select2-result"),
                            m.addClass(p ? "select2-result-selectable" : "select2-result-unselectable"),
                            g && m.addClass("select2-disabled"),
                            f && m.addClass("select2-result-with-children"),
                            m.addClass(d.opts.formatResultCssClass(u)),
                            v = e(document.createElement("div")),
                            v.addClass("select2-result-label"),
                            b = i.formatResult(u, v, r, d.opts.escapeMarkup),
                            b !== t && v.html(b),
                            m.append(v),
                            f && (y = e("<ul></ul>"), y.addClass("select2-result-sub"), o(u.children, y, l + 1), m.append(y)),
                ...
                if (a ? (i.query = this.bind(function (e) {
                    ...
                    i = n.children(),
                    this.getPlaceholder() !== t && i.length > 0 && (a = this.getPlaceholderOption(), a && (i = i.not(a))),
            ...
            monitorSource: function () {
                ...
                i.on("propertychange.select2 DOMAttrModified.select2", e),
                this.mutationCallback === t && (this.mutationCallback = function (t) {
                    t.forEach(e)
                }),
            ...
            enable: function (e) {
                e === t && (e = !0),
                this._enabled !== e && (this._enabled = e, this.opts.element.prop("disabled", !e), this.enableInterface())
            },
            disable: function () {
                this.enable(!1)
            },
            ...
            positionDropdown: function () {
                var t, i, n, a, r = this.dropdown,
                o = this.container.offset(),
                s = this.container.outerHeight(!1),
                l = r.outerHeight(!1),
                d = e(window).scrollLeft() + e(window).width(),
                h = e(window).scrollTop() + e(window).height(),
                c = o.top + s,
                u = o.left,
                p = h >= c + l,
                g = o.top - l >= this.body().scrollTop(),
                f = r.outerWidth(!1),
                m = d >= u + f,
                v = r.hasClass("select2-drop-above");
                var y = window.getComputedStyle(this.container[0]).width;
                this.opts.dropdownAutoWidth ? (a = e(".select2-results", r)[0], r.addClass("select2-drop-auto-width"), r.css("width", ""), f = r.outerWidth(!1) + (a.scrollHeight === a.clientHeight ? 0 : L.width), f > y ? y = f : f = y, m = d >= u + f) : this.container.removeClass("select2-drop-auto-width"),
                "static" !== this.body().css("position") && (t = this.body().offset(), c -= t.top, u -= t.left),
                v ? (i = !0, !g && p && (i = !1)) : (i = !1, !p && g && (i = !0)),
                m || (u = o.left + y - f),
                i ? (c = o.top - l, this.container.addClass("select2-drop-above"), r.addClass("select2-drop-above")) : (this.container.removeClass("select2-drop-above"), r.removeClass("select2-drop-above")),
                n = e.extend({
                    top: c,
                    left: u,
                    width: y
            ...
            opening: function () {
                ...
                0 == t.length && (t = e(document.createElement("div")), t.attr("id", "select2-drop-mask").attr("class", "select2-drop-mask"), t.hide(), t.appendTo(this.body()), t.on("touchstart click",
                function (t) {
            ...
            ensureHighlightVisible: function () {
                ...
                if (i = this.highlight(), !(0 > i)) {
                    if (0 == i) return l.scrollTop(0),
                    void 0;
                    t = this.findHighlightableChoices().find(".select2-result-label"),
                    n = e(t[i]),
                    a = n.offset().top + n.outerHeight(!0),
                    i === t.length - 1 && (s = l.find("li.select2-more-results"), s.length > 0 && (a = s.offset().top + s.outerHeight(!0))),
                    r = l.offset().top + l.outerHeight(!0),
                    a > r && l.scrollTop(l.scrollTop() + (a - r)),
                    o = n.offset().top - l.offset().top,
                    0 > o && "none" != n.css("display") && l.scrollTop(l.scrollTop() + o)
                }
            },
            ...
            highlight: function (t) {
                ...
                return 0 === arguments.length ? n(r.filter(".select2-highlighted")[0], r.get()) : (t >= r.length && (t = r.length - 1), 0 > t && (t = 0), this.removeHighlight(), i = e(r[t]), i.addClass("select2-highlighted"), this.ensureHighlightVisible(), a = i.data("select2-data"), a && this.opts.element.trigger({
            ...
            loadMoreIfNeeded: function () {
                ...
                0 !== i.length && (e = i.offset().top - t.offset().top - t.height(), e <= this.opts.loadMorePadding && (i.addClass("select2-active"), this.opts.query({
                    ...
                    callback: this.bind(function (e) {
                        a.opened() && (a.opts.populateResults.call(this, t, e.results, {
                            term: r,
                            page: n,
                            context: o
                        }), a.postprocessResults(e, !1, !1), e.more === !0 ? (i.detach().appendTo(t).text(a.opts.formatLoadMore(n + 1)), window.setTimeout(function () {
                            a.loadMoreIfNeeded()
                        },
                        10)) : i.remove(), a.positionDropdown(), a.resultsPage = n, a.context = e.context, this.opts.element.trigger({
                            type: "select2-loaded",
                            items: e
                        }))
                    })
            ...
            updateResults: function (i) {
                ...
                var o, s, l, d = this.search,
                h = this.results,
                c = this.opts,
                u = this,
                p = d.val(),
                g = e.data(this.container, "select2-last-term");
                if ((i === !0 || !g || !r(p, g)) && (e.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    if (f >= 1 && (o = this.data(), e.isArray(o) && o.length >= f && T(c.formatSelectionTooBig, "formatSelectionTooBig"))) return a("<li class='select2-selection-limit'>" + c.formatSelectionTooBig(f) + "</li>"),
                    void 0;
                    if (d.val().length < c.minimumInputLength) return T(c.formatInputTooShort, "formatInputTooShort") ? a("<li class='select2-no-results'>" + c.formatInputTooShort(d.val(), c.minimumInputLength) + "</li>") : a(""),
                    i && this.showSearch && this.showSearch(!0),
                    void 0;
                    if (c.maximumInputLength && d.val().length > c.maximumInputLength) return T(c.formatInputTooLong, "formatInputTooLong") ? a("<li class='select2-no-results'>" + c.formatInputTooLong(d.val(), c.maximumInputLength) + "</li>") : a(""),
                    void 0;
                    c.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + c.formatSearching() + "</li>"),
                    ...
                    c.query({
                        ...
                        callback: this.bind(function (o) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                }).length && o.results.unshift(s)), 0 === o.results.length && T(c.formatNoMatches, "formatNoMatches")) return a("<li class='select2-no-results'>" + c.formatNoMatches(d.val()) + "</li>"),
                                void 0;
                                h.empty(),
                                u.opts.populateResults.call(this, h, o.results, {
                                    term: d.val(),
                                    page: this.resultsPage,
                                    context: null
                                }),
                                o.more === !0 && T(c.formatLoadMore, "formatLoadMore") && (h.append("<li class='select2-more-results'>" + u.opts.escapeMarkup(c.formatLoadMore(this.resultsPage)) + "</li>"), window.setTimeout(function () {
                                    u.loadMoreIfNeeded()
                                },
                                10)),
                                this.postprocessResults(o, i),
                                n(),
        ...
        R = E(I, {
            ...
            opening: function () {
                ...
                this.search.focus(),
                i = this.search.get(0),
                i.createTextRange ? (n = i.createTextRange(), n.collapse(!1), n.select()) : i.setSelectionRange && (a = this.search.val().length, i.setSelectionRange(a, a)),
            ...
            initContainer: function () {
                ...
                this.focusser.attr("id", "s2id_autogen" + D()),
                e("label[for='" + this.opts.element.attr("id") + "']").attr("for", this.focusser.attr("id")),
                this.focusser.attr("tabindex", this.elementTabIndex),
                this.search.on("keydown", this.bind(function (e) {
                    if (this.isInterfaceEnabled()) {
                        if (e.which === A.PAGE_UP || e.which === A.PAGE_DOWN) return f(e),
                        void 0;
                        switch (e.which) {
                            case A.UP:
                            case A.DOWN:
                                return this.moveHighlight(e.which === A.UP ? -1 : 1),
                                f(e),
                                void 0;
                            case A.ENTER:
                ...
                this.focusser.on("keydown", this.bind(function (e) {
                    if (this.isInterfaceEnabled() && e.which !== A.TAB && !A.isControl(e) && !A.isFunctionKey(e) && e.which !== A.ESC) {
                        if (this.opts.openOnEnter === !1 && e.which === A.ENTER) return f(e),
                        void 0;
                ...
                t.on("click", this.bind(function (t) {
            ...
            onSelect: function (e, t) {
                if (this.triggerSelect(e)) {
                    ...
                    r(i, this.id(e)) || this.triggerChange({
                        added: e,
                        removed: n
                    })
                }
            ...
            updateSelection: function (e) {
                ...
                a.empty(),
                null !== e && (i = this.opts.formatSelection(e, a, this.opts.escapeMarkup)),
                i !== t && a.append(i),
                n = this.opts.formatSelectionCssClass(e, a),
                n !== t && a.addClass(n),
            ...
            data: function (e) {
                var i, n = !1;
                return 0 === arguments.length ? (i = this.selection.data("select2-data"), i == t && (i = null), i) : (arguments.length > 1 && (n = arguments[1]), e ? (i = this.data(), this.opts.element.val(e ? this.id(e) : ""), this.updateSelection(e), n && this.triggerChange({
                    added: e,
                    removed: i
                })) : this.clear(n), void 0)
            }
        ...
        N = E(I, {
            ...
            initContainer: function () {
                ...
                this.selection = t = this.container.find(i);
                var n = this;
                this.selection.on("click", ".select2-search-choice:not(.select2-locked)",
                function () {
                    n.search[0].focus(),
                    n.selectChoice(e(this))
                }),
                this.search.attr("id", "s2id_autogen" + D()),
                ...
                this.search.on("keydown", this.bind(function (e) {
                    if (this.isInterfaceEnabled()) {
                        ...
                        if (i.length && (e.which == A.LEFT || e.which == A.RIGHT || e.which == A.BACKSPACE || e.which == A.DELETE || e.which == A.ENTER)) {
                            var o = i;
                            return e.which == A.LEFT && n.length ? o = n : e.which == A.RIGHT ? o = a.length ? a : null : e.which === A.BACKSPACE ? (this.unselect(i.first()), this.search.width(10), o = n.length ? n : a) : e.which == A.DELETE ? (this.unselect(i.first()), this.search.width(10), o = a.length ? a : null) : e.which == A.ENTER && (o = null),
                            this.selectChoice(o),
                            f(e),
                            o && o.length || this.open(),
                            void 0
                        }
                        if ((e.which === A.BACKSPACE && 1 == this.keydowns || e.which == A.LEFT) && 0 == r.offset && !r.length) return this.selectChoice(t.find(".select2-search-choice:not(.select2-locked)").last()),
                        f(e),
                        void 0;
                        ...
                        if (e.which !== A.TAB && !A.isControl(e) && !A.isFunctionKey(e) && e.which !== A.BACKSPACE && e.which !== A.ESC) {
                            ...
                            this.open(),
                            (e.which === A.PAGE_UP || e.which === A.PAGE_DOWN) && f(e),
                            e.which === A.ENTER && f(e)
                        }
                    }
                })),
            ...
            addSelectedChoice: function (i) {
                ...
                d = this.id(i),
                h = this.getVal();
                n = this.opts.formatSelection(i, l.find("div"), this.opts.escapeMarkup),
                n != t && l.find("div").replaceWith("<div>" + n + "</div>"),
                a = this.opts.formatSelectionCssClass(i, l.find("div")),
                a != t && l.addClass(a),
                r && l.find(".select2-search-choice-close").on("mousedown", f).on("click dblclick", this.bind(function (t) {
            ...
            unselect: function (e) {
                ...
                if (t = e.data("select2-data")) {
                    for (; (i = n(this.id(t), a)) >= 0;) a.splice(i, 1),
                    this.setVal(a),
            ...
            postprocessResults: function (e, t, i) {
                ...
                -1 == this.highlight() && i !== !1 && s.highlight(0),
                !this.opts.createSearchChoice && !r.filter(".select2-result:not(.select2-selected)").length > 0 && (!e || e && !e.more && 0 === this.results.find(".select2-no-results").length) && T(s.opts.formatNoMatches, "formatNoMatches") && this.results.append("<li class='select2-no-results'>" + s.opts.formatNoMatches(s.search.val()) + "</li>")
            },
            ...
            resizeSearch: function () {
                ...
                40 > a && (a = i - r),
                0 >= a && (a = e),
                this.search.width(Math.floor(a))
            },
            getVal: function () {
                var e;
            ...
            val: function (i, n) {
                ...
                if (a = this.data(), a.length || (a = []), !i && 0 !== i) return this.opts.element.val(""),
                ...
                n && this.triggerChange(this.buildChangeDetails(a, this.data()));
                else {
                    ...
                    function (t) {
                        ...
                        r.updateSelection(t),
                        r.clearSearch(),
                        n && r.triggerChange(r.buildChangeDetails(a, this.data()))
                    })
                }
                this.clearSearch()
            },
        ...
        e.fn.select2 = function () {
            var i, a, r, o, s, l = Array.prototype.slice.call(arguments, 0),
            d = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"],
            ...
            return this.each(function () {
                if (0 === l.length || "object" == typeof l[0]) i = 0 === l.length ? {} : e.extend({},
                l[0]),
                i.element = e(this),
                "select" === i.element.get(0).tagName.toLowerCase() ? s = i.element.prop("multiple") : (s = i.multiple || !1, "tags" in i && (i.multiple = s = !0)),
                a = s ? new N : new R,
                a.init(i);
                else {
