    ...
    c.extend(c.validator, {
        defaults: {
            ...
            highlight: function (element) {
                ...
                if (form_group.find(".valicon").length) {
                    $(element).closest('.valicon').addClass('has-error').removeClass("has-success")
                } else {
            ...
            unhighlight: function (element) {
                var form_group = $(element).closest('.form-group');
                if (form_group.find(".valicon").length) {
                    $(element).closest('.valicon').removeClass("has-error")
                } else {
                    form_group.addClass('has-error').removeClass("has-error")
                }
            },
            success: function (element) {
                var form_group = $(element).closest('.form-group');
                if (form_group.find(".valicon").length) {
                    $(element).closest('.valicon').removeClass("has-error").addClass("has-success")
                } else {
                    form_group.addClass('has-error').removeClass("has-error").addClass("has-success")
                }
            }
        },
