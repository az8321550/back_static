...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.format = DPGlobal.parseFormat(options.format || this.element.data('date-format') || dates[this.language].format || "yyyy-mm-dd" , this.formatType);
		this.isInline = false;
	...
	Datetimepicker.prototype = {
		...
		click: function(e) {
			...
			if(_target.hasClass("today-clear")){
				$(this.element).val("").trigger("focusout").trigger("keyup");
				if($(this.element).prev().is(":input")){
					$(this.element).prev().trigger("focusout").trigger("keyup");
				}
				this.hide();
				return false;
			}
		...
		_setDate: function(date, which){
			...
			this.element.trigger("focusout").trigger("keyup");
		},
	...
	var dates = $.fn.datetimepicker.dates = {
		en: {
			days: ["日", "一", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
			daysShort: ["日", "一", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
	...
	var DPGlobal = {
		...
		footTemplate: '<tfoot style="font-size:14px;"><tr><th colspan="3" class="today-clear">清空</th><th colspan="4" class="today"></th></tr></tfoot>'
	};
